...
/* ─── Confirm Dialog ──────────────────────────────────── */
function ConfirmDialog({ isOpen, onClose, onConfirm, title, message, confirmLabel = 'Confirmar', danger = false }) {
  return (
...
/* ─── Empty State ─────────────────────────────────────── */
function EmptyState({ icon = 'inbox', title = 'Sin registros', message = 'No hay datos para mostrar.' }) {
  return (
...
/* ─── Bar Chart ───────────────────────────────────────── */
function BarChart({ data, height = 180, color = 'var(--accent)', formatValue }) {
...
/* ─── KPI Card ────────────────────────────────────────── */
function KPICard({ icon, label, value, sub, accentColor = 'var(--accent)' }) {
  return (
...
Object.assign(window, {
  AppCtx, Icon, Badge, Modal, ConfirmDialog,
  ToastContainer, SkeletonTable, EmptyState,
  BarChart, KPICard, PageHeader,
